...
namespace RecorderPack
{
    ...
    public class Recorder : SingletonComponent<Recorder>
    {
        ...
        {
           return Microphone.IsRecording(Microphone.devices[0]);
        }
        private void Update()
        {
        ...
        public static void Save(string fileName = "test")
        {
            ...
            try
            {
               ...
               AudioManager.Instance.UploadMusic(filePath, fileName + ".wav");
